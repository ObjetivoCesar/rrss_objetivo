...
// 🚀 PROPUESTA FINAL ENTRE RÍOS - ESTRUCTURA TAXIS (QUEZADA CON Z)
const slug = "propuesta-entre-rios-quezada";
const img = "https://cesarweb.b-cdn.net/activaqr/entre-rios-quezada.png";

const body = {
  id: slug,
  // NO usamos hero_image en la raíz ni campos OG manuales, 
  // para seguir la estructura exacta de la propuesta de taxis (Union Yantzatza)
  portada: {
    etiqueta: "Ecosistema Digital Entre Ríos 360",
    titulo_principal: "Entre Ríos 360: De la Gestión Manual al Liderazgo Digital",
    titulo_destacado: "Cooperativa Entre Ríos",
    subtitulo: "Preparado para Jimmy Quezada | Abril 2026",
    preparado_para: "Jimmy Quezada",
  ...
  introduccion: {
    ...
    parrafos: [
      "Jimmy Quezada, coordinar a 70 socios y sus respectivos procesos consume gran parte de la jornada administrativa. Con Entre Ríos 360, la directiva puede supervisar toda la operación en minutos, no en horas. Es la transición definitiva hacia una gestión profesional y tecnológica.",
  ...
  etapas: [
    {
      ...
      descripcion: "Cuenta de Comando Central para Jimmy Quezada + 70 Cuentas Individuales para cada socio. Un sistema unificado donde la información fluye sin necesidad de procesos manuales.",
      entregables: [
  ...
  cierre: {
    ...
    texto: "Jimmy, le propongo una reunión de 20 minutos para mostrarle cómo las 71 cuentas sincronizadas recuperarán su tiempo y blindarán la reputación de la cooperativa.",
...
async function publish() {
  console.log(`🚀 Publicando Propuesta Estilo Taxi para Jimmy Quezada...`);
  try {
